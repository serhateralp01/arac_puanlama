# Mercedes-Benz OM646 — içerik taslakları

Bu dosya `data/engines.json`
içindeki `mb-om646` kaydının `known_issues` alanından **otomatik üretildi**
(`scripts/build_content.py`). Elle düzenlenmez; kaynak değişirse yeniden üretilir.

## 1. OM611'den devralınan enjektör altı conta sorunu, zamanında değiştirilmezse enjektör tıkanması
...
- **[3-18 sn — sorun]** Anlatıcı: "OM611'den devralınan enjektör altı conta sorunu, zamanında değiştirilmezse enjektör tıkanması. Bu sık bildirilen bir durum, belirli bir kilometre sınırı bildirilmemiş. Ciddiyet seviyesi: orta."
- **[18-28 sn — kanıt]** Ekranda kaynak adı: Apex Auto Parts. Anlatıcı: "Bu bilgiyi uydurmadık; kaynağımız Apex Auto Parts."
...
2. "OM611'den devralınan enjektör altı conta sorunu, zamanında değiştirilmezse enjektör tıkanması"
3. "Belirli bir kilometre sınırı bildirilmemiş · Sıklık: sık · Ciddiyet: orta"
4. "Kaynak: Apex Auto Parts"
...
2/ OM611'den devralınan enjektör altı conta sorunu, zamanında değiştirilmezse enjektör tıkanması
3/ Belirli bir kilometre sınırı bildirilmemiş. Sıklık: sık. Ciddiyet: orta.
4/ Kaynak: Apex Auto Parts — https://www.apexautoparts.co.uk/blog/om646-engine-review-reliability-common-problems
...
Mercedes-Benz OM646 ailesinin bilinen zaaflarından biri: OM611'den devralınan enjektör altı conta sorunu, zamanında değiştirilmezse enjektör tıkanması. Belirli bir kilometre sınırı bildirilmemiş, ve bu sık bildirilen bir örüntü. Ciddiyet seviyesi "orta" olarak sınıflandırılıyor — yani izlenmesi gereken ama genelde yönetilebilir bir kalem.

Bu bilgi Apex Auto Parts kaynaklı (https://www.apexautoparts.co.uk/blog/om646-engine-review-reliability-common-problems): Mercedes OM646'nın önceki OM611'den devraldığı, enjektör altındaki ateşe dayanıklı contaların zamanında değiştirilmezse enjektörlerin tıkanmasına ve pahalı onarımlara yol açtığı; plastik emme manifoldu kanatlarının (swirl flap) zamanla kırılıp silindire düşerse ciddi motor hasarına neden olabildiği
...
---
## 2. Plastik swirl flap'ların kırılıp silindire düşmesi, ciddi motor hasarına yol açabiliyor

**Kısa video senaryosu (30-40 sn)**

- **[0-3 sn — kanca]** Ekranda Mercedes-Benz OM646 görseli. Alt yazı: "Mercedes-Benz OM646 kullanılan bir araç mı alıyorsun?"
- **[3-18 sn — sorun]** Anlatıcı: "Plastik swirl flap'ların kırılıp silindire düşmesi, ciddi motor hasarına yol açabiliyor. Bu seyrek bildirilen bir durum, belirli bir kilometre sınırı bildirilmemiş. Ciddiyet seviyesi: motor ölür."
- **[18-28 sn — kanıt]** Ekranda kaynak adı: Apex Auto Parts. Anlatıcı: "Bu bilgiyi uydurmadık; kaynağımız Apex Auto Parts."
- **[28-38 sn — kapanış]** Anlatıcı: "Mercedes-Benz OM646'in tam puan gerekçesi ve kaynak zinciri sitede — link biyoda."
...
1. "Mercedes-Benz OM646 alacaksan bunu bil 👇"
2. "Plastik swirl flap'ların kırılıp silindire düşmesi, ciddi motor hasarına yol açabiliyor"
3. "Belirli bir kilometre sınırı bildirilmemiş · Sıklık: seyrek · Ciddiyet: motor ölür"
4. "Kaynak: Apex Auto Parts"
5. "Tam gerekçe ve puan → sitede, link biyoda"
...
Mercedes-Benz OM646 ailesinin bilinen zaaflarından biri: Plastik swirl flap'ların kırılıp silindire düşmesi, ciddi motor hasarına yol açabiliyor. Belirli bir kilometre sınırı bildirilmemiş, ve bu seyrek bildirilen bir örüntü. Ciddiyet seviyesi "motor ölür" olarak sınıflandırılıyor — yani bu, bir bakım kalemi ötesine geçip büyük bir onarım gerektirebilir.
